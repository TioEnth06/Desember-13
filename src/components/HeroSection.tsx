...
export const HeroSection = () => {
  return (
    <div className="relative overflow-hidden rounded-2xl hero-gradient p-4 md:p-8 text-primary-foreground min-h-[400px] md:h-[400px]">
      {/* Abstract shapes */}
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center h-full gap-6 md:gap-0">
        ...
        <div className="bg-navy-light/50 backdrop-blur-sm rounded-xl p-5 border border-primary-foreground/10 w-full md:w-auto">
          ...
          <div className="grid grid-cols-2 gap-2">
            {stats.map((stat, index) => (
              <div key={index} className="text-center bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-4 w-full md:w-[200px]">
